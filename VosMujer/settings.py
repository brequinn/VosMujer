"""
Django settings for VosMujer project.
...
SECRET_KEY = 'r%!l*_#oz1%jnf(knyz94mww5q@6kwye&3_a!!t!brz34b916d'
...
ALLOWED_HOSTS = ['vosmujer.herokuapp.com', '127.0.0.1']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'd5ob439gqtqn4f',
        'USER': 'vsawtfzixkjfmu',
        'PASSWORD': '0c1e42575461720a59d0f9740a74bad27dc58753df27d65ed7f1d2ee54f249b3',
        'HOST': 'ec2-50-19-86-17.compute-1.amazonaws.com',
        'PORT': 5432,
    }
}
...
WSGI_APPLICATION = 'VosMujer.wsgi.application'
